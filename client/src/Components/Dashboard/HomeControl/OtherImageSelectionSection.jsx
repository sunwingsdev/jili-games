...
const OtherImageSelectionSection = ({ version, category }) => {
  ...
  const ourGamesImageControls = homeControls?.filter(
    (control) =>
      control.page === "home" &&
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-4 mb-10">
      {ourGamesImageControls?.map((control) => (
        <div
...
export default OtherImageSelectionSection;
